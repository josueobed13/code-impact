        ...
        <div class="footer__grid">
            ...
            <div class="footer__col footer__brand">
                ...
                <div class="footer__social">
                    ...
                    <!-- FACEBOOK -->
                    <a
                        href="https://www.facebook.com/CodeImpact.Peru"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="Facebook"
                    >

                        <svg fill="#fff" width="28" height="28" viewBox="0 0 24 24">
                    ...
                    <!-- INSTAGRAM -->
                    <a
                        href="https://www.instagram.com/code.impactperu/"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    >
                        ...
                        <svg fill="#fff" width="30" height="30" viewBox="0 0 24 24">
...
<script src="<?= BASE_URL; ?>build/js/ui.min.js?v=<?= filemtime(__DIR__ . '/../../public/build/js/ui.min.js'); ?>" ></script>
